		...
		echo"<a href='?module=produk&act=tambahdata' class='nav-link text-black'><i class='fa fa-plus-circle' ></i> Tambah</a>
		 ...
		 <thead>
			...
			while($r = mysqli_fetch_array($data))
			{
				$no++;
		echo"<tr>
				<td>$no</td>  <td>$r[nm_kategori]</td> <td>$r[nm_produk]</td> <td>$r[deskripsi]</td> <td> <img src=module/produk/img/$r[gambar] width=120px  ></td> <td>$r[ukuran]</td> <td>$r[harga]</td> <td>$r[stok]</td>
				<td> 
