...
if (empty($_SESSION['username']) AND empty ($_SESSION['password'])) {
	...
	elseif ($module=='produk' AND $act=='input') {
		mysqli_query($konek,"INSERT INTO produk values ('$_POST[id_produk]','$_POST[nm_produk]','$_POST[deskripsi]','$_POST[gambar]','$_POST[ukuran]','$_POST[harga]','$_POST[stok]')");
		header('location:../../home.php?module='.$module);
	}

	//update memanggil file kategorieditsim.php
	elseif ($module=='produk' AND $act=='update') {
		mysqli_query($konek,"UPDATE  set id_produk='$_POST[id_produk]',nm_produk='$_POST[nm_produk]',deskripsi='$_POST[deskripsi]',gambar='$_POST[gambar]',ukuran='$_POST[ukuran]',harga='$_POST[harga]',stok='$_POST[stok]'
