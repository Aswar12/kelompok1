...
$aksi="module/det_pembelian/aksi_det_pembelian.php";
	...
	default:
		...
		echo"<a href='?module=det_pembelian&act=tambahdata'> Tambah </a>
		 ...
		 <thead>
			<tr>
				<th>NO</th> <th>ID Keranjang</th> <th>Nama Produk</th> <th>Nama Pembeli</th> <th>Kecamatan</th> <th>Alamat</th> <th>Status</th> <th>Tgl Pembelian</th> <th>Pilihan</th>
			</tr></thead>";
			$no=0;			
			$data = mysqli_query($konek,"SELECT * FROM det_pembelian inner join keranjang on det_pembelian.id_keranjang = keranjang.id_keranjang inner join pembeli on pembeli.id_pembeli = det_pembelian.id_pembeli inner join kecamatan on kecamatan.id_kecamatan = det_pembelian.id_kecamatan");
